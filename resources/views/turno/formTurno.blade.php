		...
		<div class="row">
			...
			<div class="col-lg-10">
				<div class="form-group col-lg-6">
					{!! Form::text('horario[1][inicio]', $horario->inicio, ['class'=>'form-control hora', 'placeholder'=>'Início' ,'minlength' => '5', 'required']) !!}
				</div>

				<div class="form-group col-lg-6">
					{!! Form::text('horario[1][fim]', $horario->fim, ['class'=>'form-control hora', 'placeholder'=>'Fim' ,'minlength' => '5', 'required']) !!}
				</div>
			</div>
